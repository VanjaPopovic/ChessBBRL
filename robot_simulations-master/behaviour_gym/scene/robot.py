...
class UR103F(robot.Robot):
    ...
    def __init__(self, physicsClient, restPos=[0.7, 0.0, 0.4],
                 ...
                 maxGripMove=0.05, maxGripForce=2.0, **kwargs):
        ...
        self.all_joints = [1, 2, 3, 4, 5, 6, 9, 13, 10, 14, 18, 11, 15, 19, 12, 16, 20]
    ...
    def getGripperObs(self):
        # Arm kinematics
        eeLinkState = self.p.getLinkState(self.id, self.eeLink, computeLinkVelocity=True)
    ...
    def getJointStates(self):
        all_joint_states = self.p.getJointStates(self.id, self.all_joints)
