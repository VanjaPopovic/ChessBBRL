...
print("========================================")
demo_paths = sample_paths(num_traj=1000, policy=Expert(), env=e)
expert_demo_file = 'expert_demos.pickle'
pickle.dump(demo_paths, open('logs/' + expert_demo_file, 'wb'))
# with open("logs/" + expert_demo_file, 'rb') as pickle_file:
...
bc_agent.logger.save_log('logs/')
make_train_plots(log=bc_agent.logger.log, keys=["loss"], save_loc='logs/')
policy_file = 'policy_bc.pickle'
pickle.dump(bc_agent.policy, open('logs/' + policy_file, 'wb'))
