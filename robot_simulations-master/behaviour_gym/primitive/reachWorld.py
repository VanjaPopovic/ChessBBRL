...
class ReachWorld(primitive.Primitive):

    def __init__(self, goalObject, graspGenerator, goalPosOffset=[0,0,0.01],
                 maxMove=0.05, maxRotation=math.pi/20,
        ...
        self.graspGenerator = graspGenerator
        ...
        super(ReachWorld, self).__init__(*args, **kwargs)
    ...
    def _randomise(self):
        ...
        armStartPos = [random.uniform(self.posRange[0][0],
                       ...
                       random.uniform(self.posRange[1][0],
                                      self.posRange[1][1]),
                       random.uniform(self.posRange[2][0] + 0.3,
                                      self.posRange[2][1])]
