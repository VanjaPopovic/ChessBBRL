...
if __name__ == '__main__':
    ...
    episode_rewards, episode_lengths, episode_lift_dists, episode_success = [], [], [], []
    for i in range(episodes):
        ...
        episode_lift_dists.append(info[0]['lift distance'])
    ...
    print("Mean Final Lift Distance: {}cm".format(np.mean(episode_dists)))
